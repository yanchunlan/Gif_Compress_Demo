...
jlong JNICALL
Java_com_example_gif_1compress_1demo_GifInfoHandle_openFile(JNIEnv *env, jobject instance,
                                                            jstring path_) {
	return openFile(env,path_);
}

JNIEXPORT jlong JNICALL
Java_com_example_gif_1compress_1demo_GifInfoHandle_renderFrame__JLandroid_graphics_Bitmap_2(
		JNIEnv *env, jobject instance, jlong gifInfoAddress, jobject bitmap) {

	return renderFrame(env, gifInfoAddress,bitmap);
}

JNIEXPORT jint JNICALL
Java_com_example_gif_1compress_1demo_GifInfoHandle_getWidth__J(JNIEnv *env, jobject instance,
															   jlong gifInfoAddress) {
	return getWidth(gifInfoAddress);
}

JNIEXPORT jint JNICALL
Java_com_example_gif_1compress_1demo_GifInfoHandle_getHeight__J(JNIEnv *env, jobject instance,
																jlong gifInfoAddress) {
